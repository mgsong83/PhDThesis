...
double y_min = -0.263 * 10e-6;
//double y_max = 0.1. * 10e-6;
double y_max = -0.105 * 10e-6;
double y_min_ratio = 0.5;
double y_max_ratio = 1.52;

double sc_input = -1.86111e-06;

double leg_y_min = 0.1;
double leg_y_max = 0.3;

TString strSaveFile = "figs_SC_comparison/SC_Comparison_SC32_ToyMC_lowM.eps";
const int ND = 4; // number of Data sets
TString datainfo[ND][3] = {
	"Results/results_Toy_Eta00_lowM_nojet_ToyMCwJet.root", 	"gr_SC_corr_0", 		"SC(3,2) : SP",
	"Results/results_Toy_Eta00_lowM_nojet_ToyMCwJet.root", 	"gr_SC_with_QC_3223", 	"SC(3,2) : QC",
	"Results/results_Toy_Eta00_lowM_jet_ToyMCwJet.root", 		"gr_SC_corr_0", 			"SC(3,2) : SP + PYTHIA Jet",
	"Results/results_Toy_Eta00_lowM_jet_ToyMCwJet.root", 		"gr_SC_with_QC_3223", 	"SC(3,2) : QC + PYTHIA Jet"
//	"Results/results_Toy_Eta08_lowM_ToyMCwJet.root", "gr_SC_corr_0", "SC(3,2) : SP + PYTHIA Jet (#Delta#eta>0.8)"
};
